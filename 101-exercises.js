...
const isPositiveOdd = (value) => isPositive(value) && isOdd(value);
...
const isPositiveEven = (value) => isPositive(value) && isEven(value);
...
const isNegativeOdd = (value) => isNegative(value) && isOdd(value);
...
const isNegativeEven = (value) => isNegative(value) && isEven(value);
...
const reverseSign = (value) => value * -1;
...
const absoluteValue = (value) => isPositive(value) ? value : reverseSign(value);
...
const isMultipleOfBothThreeAndFive = (value) => isMultipleOfThree(value) && isMultipleOfFive(value);
...
const timesTwoPlusThree = (value) => value * 2 + 3;
...
const areaOfRectangle = multiply;
...
const areaOfCircle = (radius) => square(radius) * Math.PI;
...
const hasVowels = (word) => word.replace(/[aeiou]/gi, '') !== word;
...
const countVowels = (word) => word.length - word.replace(/[aeiou]/gi, '').length;
...
const removeVowels = (word) => word.replace(/[aeiou]/gi, '');
...
const startsWithVowel = (word) => word.replace(/[aeiou]/i, '') === word.slice(1);
...
const endsWithVowel = (word) => word.replace(/[aeiou]$/i, '') === word.slice(0, word.length - 1);
...
const startsAndEndsWithVowel = (word) => startsWithVowel(word) && startsWithVowel(word);
...
const last = (word) => word[word.length - 1];
...
const secondToLast = (word) => word[word.length - 2];
...
const thirdToLast = (word) => word[word.length - 3];
...
const firstAndSecond = (values) => [first(values), second(values)];
...
const firstAndLast = (values) => [first(values), last(values)];
...
const mean = (value) => sumAll(value) / value.length;
...
const maxMinusMin = (values) => values.sort()[values.length - 1] - values[0];
...
const getHighestNumber = (values) => values.sort()[values.length - 1];
...
const getSmallestNumber = (values) => values.sort()[0];
...
const onlyOddNumbers = (values) => values.filter(value => isOdd(value));
...
const onlyEvenNumbers = (values) => values.filter(value => isEven(value));
...
const onlyPositiveNumbers = (values) => values.filter(value => isPositive(value));
...
const onlyNegativeNumbers = (values) => values.filter(value => isNegative(value));
...
const hasEvens = (values) => Boolean(values.filter(value => isEven(value)).length);
...
const countEvens = (values) => values.filter(value => isEven(value)).length;
...
const hasOdds = (values) => Boolean(values.filter(value => isOdd(value)).length);
...
const countOdds = (values) => values.filter(value => isOdd(value)).length;
...
const countNegatives = (values) => values.filter(value => isNegative(value)).length;
...
const countPositives = (values) => values.filter(value => isPositive(value)).length;
...
const onlyPositiveEvens = (values) => values.filter(value => isPositive(value) && isEven(value));
...
const onlyPositiveOdds = (values) => values.filter(value => isPositive(value) && isOdd(value));
...
const onlyNegativeEvens = (values) => values.filter(value => isNegative(value) && isEven(value));
...
const onlyNegativeOdds = (values) => values.filter(value => isNegative(value) && isOdd(value));
...
const shortestString = (values) => values.sort((a, b) => a.length - b.length)[0];
...
const longestString = (values) => values.sort((a, b) => b.length - a.length)[0];
...
const getUniqueValues = (values) => {
    ...
    values.forEach(value => newResult.includes(value) ? null : newResult.push(value));
...
const elementsTimesTwo = (values) => values.map(value => value * 2);
...
const flatten = (values) => {
    ...
    values.forEach(value => newResult.push(...value));
...
const addOneToArray = (values) => values.map(value => value + 1);
...
const getNumberOfBooks = (values) => values.length;
...
const totalOfBookPrices = (values) => {
    let totalValue = 0;

    values.forEach(value => totalValue += value.price);
...
const getAverageBookPrice = (values) => totalOfBookPrices(values) / getNumberOfBooks(values);
...
const highestPriceBook = (values) => values.sort((a, b) => b.price - a.price)[0];
...
const lowestPriceBook = (values) => values.sort((a, b) => a.price - b.price)[0];
...
const getTaxRate = (object) => object.tax;
...
const numberOfItemTypes = (object) => object.items.length;
...
const totalNumberOfItems = (object) => {
    let totalValue = 0;

    object.items.forEach(value => totalValue += value.quantity);
...
const getAverageItemPrice = (object) => {
    ...
    object.items.forEach(value => totalValue += value.price);

    return totalValue / object.items.length;
};
...
const mostSpentOnItem = (object) => {
    ...
    object.items.forEach(value => {
        !result ?
            result = value :
            result.quantity * result.price < value.quantity * value.price ?
                result = value :
                null;
    });
